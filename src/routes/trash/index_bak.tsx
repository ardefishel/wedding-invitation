...
import "./index_bak.css";
import Envelope from "@/components/Envelope";
import { Envelope as NewEnvelope } from "@/components/Envelope";

export const Route = createFileRoute("/trash/index_bak")({
