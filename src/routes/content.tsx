...
function RouteComponent() {
  return (
    ...
    // </div>
    <div
      className="h-dvh overflow-y-scroll no-scrollbar pb-8"
      style={{
    ...
    >
      ...
      <div className="max-w-lg mx-auto">
        <PaperSection>
          ...
          <p className="font-kalam text-[2.6cqi] leading-snug text-center text-[#4a4a4a] max-w-sm mx-auto mb-10 ">
        ...
        <PaperSection className="-mt-[4cqi] w-full text-center">
          <h2 className="font-noto-serif uppercase text-lg sm:text-xl tracking-widest mb-6 text-[#3a3a3a]">
            Awal kami bertemu...
          </h2>
